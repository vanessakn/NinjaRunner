...
class ContentPack {
  ...
  factory ContentPack.fromJson(Map<String, Object?> json) {
    final prompts = _list(json, 'prompts').map(RunnerPrompt.fromJson).toList();
    if (prompts.isEmpty) {
...
class RunnerPrompt {
  ...
  factory RunnerPrompt.fromJson(Map<String, Object?> json) {
    ...
    return RunnerPrompt(
      ...
      imageAssetId: _optionalString(json, 'imageAssetId'),
      audioAssetId: _optionalString(json, 'audioAssetId'),
    );
  }
